...
public class UI extends AppCompatActivity
{
    ...
    private void appendRow(Equity equity)
    {
       ...
       //here, I am comparing the yield of each stock with 0.05 because during the output it gets multiplied by 100 and 5/100 = 0.05
       if(equity.getYield() > 0.05)
          row.setBackgroundColor(Color.rgb(0,255,0));//this statement uses the setBackgroundColor() method of the table row class
        //with the parameters being the rgb() method of the Color class.
