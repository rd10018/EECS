...
//			}
		...
		int m = Integer.parseInt(x.charAt(i)+ "");
		int n =  Integer.parseInt(y.charAt(i) + "");
		result+= (m + n)%2;
	...
	public static String xor26(String x , String y)
	{
		String result = "";
		for(int i =0 ; i < x.length(); i++)
		{		
	...
	/**
	 * 
	 * function to calculate the bit-wise complement of the binary array
	 */
	
	public static String bitwiseComplement(String original)
	{
		String negated = "";
	 ...
	 **/
	public static double getIC(byte[] ar, int sample)
	{
		double ic = 0.0;
		int trials = sample; // the number of total outcomes
		int count = 0; //number of favourable outcomes
